...
L = 168
T = 48
feature_numbers = [8] #3,5,7,9,10
# feature_number = 6 # number of features for training in each building
for feature_number in feature_numbers:
    for x in range(1):
        if x == 0:
            # linear experiments ---------------------------------------------------------------------------------------------------
            expt_name = f'linear_{seed}_f{feature_number}'
        ...
        if x == 1:
            # resmlp experiments ---------------------------------------------------------------------------------------------------
            expt_name = f'resmlp_{seed}_f{feature_number}'
        ...
        if x == 2:
            # conv experiments -----------------------------------------------------------------------------------------------------
            expt_name = f'conv_{seed}_f{feature_number}'
