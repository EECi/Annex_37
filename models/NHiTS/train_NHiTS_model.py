...
def main(model_group_name, model_type, model_name, building_index, train_path, val_path):
    ...
    train_ds,val_ds = NHiTS_group.format_CityLearn_datasets([train_path,val_path], model_type=model_type, model_name=model_name, building_index=building_index)

    # continue training on specified model
    NHiTS_group.train_model(model_name,model_type,train_ds,val_ds)
