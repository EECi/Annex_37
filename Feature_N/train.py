...
L = 168
T = 48
# feature_number = 11 # number of features for training in each building
feature_numbers = [10]#3,4,5,6,7,8,9,
for feature_number in feature_numbers:
    for x in range(1):

        if x == 0:
            # linear experiments ---------------------------------------------------------------------------------------------------
            expt_name = f'linear_{seed}_f{feature_number}N'
        ...
        if x == 1:
            # resmlp experiments ---------------------------------------------------------------------------------------------------
            expt_name = f'resmlp_{seed}_f{feature_number}N'
        ...
        if x == 2:
            # conv experiments -----------------------------------------------------------------------------------------------------
            expt_name = f'conv_{seed}_f{feature_number}N'
        ...
        start = time.time()
        predictor = Predictor(mparam_dict, building_indices, L, T, expt_name, load=False, feature_number = feature_number)
        predictor.train(patience=10, max_epoch=50)
        end = time.time()
